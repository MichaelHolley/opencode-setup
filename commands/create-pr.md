...
6. Create the pull request using the GitHub MCP or GitHub CLI. If no template was found, write a very short body/description for the pull request and use the `--fill` flag (if using CLI) or equivalent to automatically generate the title.
